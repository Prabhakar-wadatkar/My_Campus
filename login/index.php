...
<header>
            ...
            <li><div><a href="#"></a><i class="fa fa-inbox" aria-hidden="true"></i> What's New</div></li>
            <li><div><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="./Contact us/index.html">Contact</a></div></li>				
			</ul>
		</header>
<body>
	<div class="container">
